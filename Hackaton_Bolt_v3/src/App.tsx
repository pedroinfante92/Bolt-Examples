...
import CatalunyaMap from './components/CatalunyaMap';
import WaterPulseChart from './components/WaterPulseChart';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <CatalunyaMap consumptionData={consumptionData} anomalies={anomalies} />
          <WaterPulseChart consumptionData={consumptionData} anomalies={anomalies} />
        </div>
